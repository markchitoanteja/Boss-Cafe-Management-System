...
function init_sidebar() {
    ...
    $SIDEBAR_MENU.find("a").on("click", function (t) {
        ...
        n.is(".active")
            ...
            : (n.parent().is(".child_menu") ? $BODY.is("nav-sm") && !n.parent().is("child_menu") && a() : a(),
                n.addClass("active"),
...
$(".bulk_action input").on("ifChecked", function () {
    ...
    $(document).ready(function () {
        $(".expand").on("click", function () {
            $(this).next().slideToggle(200), "+" == ($expand = $(this).find(">:first-child")).text() ? $expand.text("-") : $expand.text("+");
        });
    }),
...
function init_flot_chart() {
    if (void 0 !== $.plot) {
        for (
            ...
            t.push([new Date(Date.today().add(n).days()).getTime(), Math.floor(21 * Math.random()) + 20 + n + n + 10]);
        var o = {
        ...
        $("#chart_plot_01").length &&
            ...
            $("#chart_plot_02").length && $.plot($("#chart_plot_02"), [{ label: "Email Sent", data: t, lines: { fillColor: "rgba(150, 202, 89, 0.12)" }, points: { fillColor: "#fff" } }], o),
...
function init_wysiwyg() {
    function e() {
        var e = $("[title=Font]").siblings(".dropdown-menu");
        if (
            ($.each(["Serif", "Sans", "Arial", "Arial Black", "Courier", "Courier New", "Comic Sans MS", "Helvetica", "Impact", "Lucida Grande", "Lucida Sans", "Tahoma", "Times", "Times New Roman", "Verdana"], function (a, t) {
                e.append($('<li><a data-edit="fontName ' + t + '" style="font-family:\'' + t + "'\">" + t + "</a></li>"));
            }),
                ...
                $("[data-role=magic-overlay]").each(function () {
                    var e = $(this),
                        a = $(e.data("target"));
                    e.css("opacity", 0).css("position", "absolute").offset(a.offset()).width(a.outerWidth()).height(a.outerHeight());
                }),
            ...
            $(".voiceBtn")
                ...
                .offset({ top: a.top, left: a.left + $("#editor").innerWidth() - 35 });
        } else $(".voiceBtn").hide();
    }
    function a(e, a) {
        var t = "";
        "unsupported-file-type" === e && (t = "Unsupported format " + a),
    ...
    if (void 0 !== $.fn.cropper) {
        var e,
            ...
            d = {
                ...
                preview: ".img-preview",
                crop: function (e) {
                    n.val(Math.round(e.x)), o.val(Math.round(e.y)), i.val(Math.round(e.height)), r.val(Math.round(e.width)), l.val(e.rotate), s.val(e.scaleX), _.val(e.scaleY);
                },
            };
        $('[data-toggle="tooltip"]').tooltip(),
            ...
            void 0 === t[0].download && t.addClass("disabled"),
                ...
                a.data("cropper") &&
                    ("checkbox" === i
                        ? ((d[o] = n.prop("checked")),
                            ...
                            (t = a.cropper("getCanvasData")),
                            (d.built = function () {
                                a.cropper("setCropBoxData", e), a.cropper("setCanvasData", t);
                            }))
                        : "radio" === i && (d[o] = n.val()),
                        a.cropper("destroy").cropper(d));
            }),
            $(".docs-buttons").on("click", "[data-method]", function () {
                var e,
                    ...
                    o = $(this),
                    i = o.data();
                if (!(o.prop("disabled") || o.hasClass("disabled")) && a.data("cropper") && i.method) {
                    if (void 0 !== (i = $.extend({}, i)).target && ((e = $(i.target)), void 0 === i.option))
                        try {
                            i.option = JSON.parse(e.val());
                        } catch (r) { }
                    switch (((n = a.cropper(i.method, i.option, i.secondOption)), i.method)) {
                        case "scaleX":
                        case "scaleY":
                            $(this).data("option", -i.option);
                            break;
                        case "getCroppedCanvas":
                            n && ($("#getCroppedCanvasModal").modal().find(".modal-body").html(n), t.hasClass("disabled") || t.attr("href", n.toDataURL()));
                    }
                    if ($.isPlainObject(n) && e)
                        try {
        ...
        u
            ...
            : c.prop("disabled", !0).parent().addClass("disabled");
    }
}
function init_knob() {
    if (void 0 !== $.fn.knob) {
...
function init_daterangepicker_reservation() {
    void 0 !== $.fn.daterangepicker && ($("#reservation").daterangepicker(null, function (e, a, t) { }), $("#reservation-time").daterangepicker({ timePicker: !0, timePickerIncrement: 30, locale: { format: "MM/DD/YYYY h:mm A" } }));
}
...
function init_PNotify() {
    if ("undefined" == typeof PNotify) return;
}
    ...
    if ("undefined" != typeof CustomTabs) {
        ...
        (TabbedNotification = function (a) {
            ...
            document.getElementById("custom_notifications")
                ? ($("#custom_notifications ul.notifications").append("<li><a id='ntlink" + e + "' class='alert-" + a.type + "' href='#ntf" + e + "'><i class='fa fa-bell animated shake'></i></a></li>"),
        ...
        $(document).on("click", ".notification_close", function (e) {
            (a = (idname = $(this).parent().parent().attr("id")).substr(-2)),
                $("#ntf" + a).remove(),
                $("#ntlink" + a)
                    .parent()
                    .remove(),
    ...
    if (void 0 !== $.fn.fullCalendar)
        var e,
            ...
            r = $("#calendar").fullCalendar({
                ...
                select: function (t, n, o) {
                    $("#fc_create").click(),
                        ...
                        $(".antosubmit").on("click", function () {
                            var t = $("#title").val();
                            return (
                                n && (ended = n), (a = $("#event_type").val()), t && r.fullCalendar("renderEvent", { title: t, start: e, end: n, allDay: o }, !0), $("#title").val(""), r.fullCalendar("unselect"), $(".antoclose").click(), !1
                            );
                        });
                },
                ...
                editable: !0,
                events: [
                    { title: "All Day Event", start: new Date(i, o, 1) },
                    { title: "Long Event", start: new Date(i, o, n - 5), end: new Date(i, o, n - 2) },
                    { title: "Meeting", start: new Date(i, o, n, 10, 30), allDay: !1 },
                    { title: "Lunch", start: new Date(i, o, n + 14, 12, 0), end: new Date(i, o, n, 14, 0), allDay: !1 },
                    { title: "Birthday Party", start: new Date(i, o, n + 1, 19, 0), end: new Date(i, o, n + 1, 22, 30), allDay: !1 },
                    { title: "Click for Google", start: new Date(i, o, 28), end: new Date(i, o, 29), url: "http://google.com/" },
                ],
            });
}
...
function init_DataTables() {
    if (void 0 !== $.fn.DataTable) {
        ...
        (TableManageButtons = {
            ...
            $("#datatable").dataTable({ ordering: false }), // Disable sorting
            $("#datatable-keytable").DataTable({ keys: !0, ordering: false }), // Disable sorting
            $("#datatable-responsive").DataTable({ ordering: false }), // Disable sorting
            ...
            $("#datatable-fixed-header").DataTable({ fixedHeader: !0, ordering: false }); // Disable sorting
...
function init_echarts() {
    if ("undefined" != typeof echarts) {
        ...
        if (
            ...
            var t = { normal: { label: { show: !1 }, labelLine: { show: !1 } } },
                n = { normal: { color: "rgba(0,0,0,0)", label: { show: !1 }, labelLine: { show: !1 } }, emphasis: { color: "rgba(0,0,0,0)" } };
        }
        $("#echart_mini_pie").length &&
                ...
                series: [
                    {
                        ...
                        data: [
                            ...
                            { value: 32, name: "invisible", itemStyle: n },
                        ],
                    },
                    {
                        name: "2",
                        ...
                        data: [
                            ...
                            { value: 71, name: "invisible", itemStyle: n },
                        ],
                    },
                    {
                        name: "3",
                        ...
                        data: [
                            ...
                            { value: 97, name: "invisible", itemStyle: n },
                        ],
                    },
                ],
            }),
            $("#echart_world_map").length &&
